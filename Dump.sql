...
--
-- Host: 127.0.0.1    Database: tienda_mascotas
-- ------------------------------------------------------
...
INSERT INTO `clientes` VALUES (2,'julio','cesar@HOTMAIL.COM','987654321','Jr . 2 de mayo 23');
...
INSERT INTO `productos` VALUES (1,'Pedigri','Croquetas para Perro adulto',60.00,12);
...
CREATE TABLE `promociones` (
  ...
  `criterio_segmentacion` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `promociones` VALUES (1,'alimeto perros','PORCENTAJE',10.00,'2025-07-04','2025-07-09','Descuentos para los nuevos clientes');
...
CREATE TABLE `recordatorios` (
  ...
  CONSTRAINT `recordatorios_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `recordatorios` VALUES (1,'Comprar para gatos','2025-07-06',NULL);
...
CREATE TABLE `ventas` (
  ...
  PRIMARY KEY (`id`),
  KEY `cliente_id` (`cliente_id`),
  CONSTRAINT `ventas_ibfk_1` FOREIGN KEY (`cliente_id`) REFERENCES `clientes` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `ventas` VALUES (2,2,'2025-07-15',70.00);
...
-- Dump completed on 2025-07-05 12:10:53
